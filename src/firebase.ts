...
export async function uploadToCloudinary(file: File) {
  ...
  formData.append('upload_preset', import.meta.env.VITE_CLOUDINARY_UPLOAD_PRESET || 'hawainn-khabaru');

  const response = await fetch(`https://api.cloudinary.com/v1_1/${import.meta.env.VITE_CLOUDINARY_CLOUD_NAME || 'g5gx7fe7'}/upload`, {
    method: 'POST',
    body: formData,
  });
